...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'SystemPayTransaction', fields ['trans_date', 'trans_id']
        db.delete_unique('systempay_systempaytransaction', ['trans_date', 'trans_id'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'SystemPayTransaction', fields ['trans_date', 'trans_id']
        db.create_unique('systempay_systempaytransaction', ['trans_date', 'trans_id'])
